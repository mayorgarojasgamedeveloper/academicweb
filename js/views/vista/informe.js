...
$('document').ready(function() {
  ...
  .done(function(data) {
    ...
    $.ajax({url: `http://localhost:3000/informetecnico/${id}`, method: `get`})
    .done(function(data) {
      console.log(data);
      // Agregar informacion
      ...
      $('#dependencia').val(data[0].dependencia);
  ...
  $('#menu').on('click', '#btn_eliminar', function() {
    ...
    function(){
      $.ajax({url: `http://localhost:3000/informetecnico`, data: {id: id}, method: `delete`})
      .done(function(data) {
  ...
  $('#menu').on('click', '#btn_guardar', function() {
    ...
    $.ajax({url: `http://localhost:3000/informetecnico/${id}`, data: objeto, method: `put`})
    .done(function(data) {
  ...
  $('#btn_descargar').on('click', function() {
    ...
    doc.setFontSize(15);
    doc.text('Informe Técnico', 15, 60);
    ...
    doc.setFontSize(15);
    doc.text('Dependencia: ', 15, 160);
    doc.setFontSize(19);
    doc.text($('#dependencia').val(), 15, 170);
