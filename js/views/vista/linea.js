...
$('document').ready(function() {
  ...
  $('#menu').on('click', '#btn_guardar', function() {
    ...
    $.ajax({url: `http://localhost:3000/lineainovadora/${id}`, data: objeto, method: `put`})
    .done(function(data) {
      alertify.alert(`Academic`, `La Linea "${objeto["linea"]}" ha sido editada exitosamente.`, function(){
        location.reload();
      });
    });
