...
$('document').ready(function() {
  ...
  .done(function(data) {
    ...
    $.ajax({url: `http://localhost:3000/reporte2/${id}`, method: `get`})
    .done(function(data) {
      console.log(data);
      ...
      $('#nom_libro').val(data[0].nom_libro);
  ...
  $('#menu').on('click', '#btn_eliminar', function() {
    ...
    function(){
      $.ajax({url: `http://localhost:3000/reporte2`, data: {id: id}, method: `delete`})
      .done(function(data) {
  ...
  $('#menu').on('click', '#btn_guardar', function() {
    ...
    $.ajax({url: `http://localhost:3000/reporte2/${id}`, data: objeto, method: `put`})
    .done(function(data) {
  ...
  $('#btn_descargar').on('click', function() {
    ...
    doc.setFontSize(15);
    doc.text('Capítulo del libro', 15, 60);
    ...
    doc.setFontSize(15);
    doc.text('ISBN: ', 15, 160);
    doc.setFontSize(19);
    doc.text($('#isbn').val(), 15, 170);
    doc.setFontSize(15);
    doc.text('Nombre de Libro: ', 15, 180);
    doc.setFontSize(19);
    doc.text($('#nom_libro').val(), 15, 190);
